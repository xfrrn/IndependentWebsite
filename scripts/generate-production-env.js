...
const env = {
  ...
  NEXT_PUBLIC_STRIPE_KEY: existing.get("NEXT_PUBLIC_STRIPE_KEY") || "",
  NEXT_PUBLIC_MEDUSA_PAYMENTS_PUBLISHABLE_KEY:
    existing.get("NEXT_PUBLIC_MEDUSA_PAYMENTS_PUBLISHABLE_KEY") || "",
  NEXT_PUBLIC_MEDUSA_PAYMENTS_ACCOUNT_ID:
    existing.get("NEXT_PUBLIC_MEDUSA_PAYMENTS_ACCOUNT_ID") || "",
}
...
NEXT_PUBLIC_MEDUSA_PAYMENTS_PUBLISHABLE_KEY=${env.NEXT_PUBLIC_MEDUSA_PAYMENTS_PUBLISHABLE_KEY}
NEXT_PUBLIC_MEDUSA_PAYMENTS_ACCOUNT_ID=${env.NEXT_PUBLIC_MEDUSA_PAYMENTS_ACCOUNT_ID}
`
