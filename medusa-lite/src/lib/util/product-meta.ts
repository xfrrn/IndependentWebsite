...
export function getAgeRange(product: StoreProduct) {
  return getMetadataString(product, "age_range")
}

export function getToyType(product: StoreProduct) {
  return getMetadataString(product, "toy_type")
}

export function getHighlight(product: StoreProduct) {
  return getMetadataString(product, "highlight")
}

export function getSkills(product: StoreProduct): string[] {
  return splitTokens(getMetadataString(product, "skills"))
}

export function getTagValues(product: StoreProduct): string[] {
...
export function matchesAgeRange(product: StoreProduct, slug: string) {
...
export function matchesCategoryKey(product: StoreProduct, slug: string) {
  const raw = getMetadataString(product, "category_key")
  if (!raw) return false
  return normalize(raw) === normalize(slug)
}

export function matchesScenarioKey(product: StoreProduct, slug: string) {
